/** Bubble News jQuery plugin v0.1
 *  (c) Michele Puddu - http://www.oim-worlds.com/
...
(function($, undefined){
    ...
    var pluginName = "bubbleNews",
    	feed = undefined,
    	selector = null,
    	copyText = "<p>Bubbles News: <strong>Michi P</strong>: <em>modok64@hotmail.com</em></p>";
        $dom = {
    		global : null,
    		insertNewFeed: null,
    		alert:null,
    ...
    var methods = {
        ...
        init: function (_opt) {
            ...
            $("<script>function updateFeed(feed) {$('" + $this.selector + "')." + pluginName + "('update', feed.query); " + "}</script>").appendTo('head');
            $("<script>function receiverFeed(feed) {$('" + $this.selector + "')." + pluginName + "('receive', feed.query); " + "}</script>").appendTo('head');
        ...
        receive: function(_feed) {
        	...
        	$dom.copy.html('Feed from: <a href="' + $dom.global.data(pluginName).url + '" target="_blank">' + $dom.global.data(pluginName).url + "</a>").append(copyText);
        ...
        newFeed: function (url) {
        	...
        	$dom.copy.html('Feed from: <a href="' + url + '" target="_blank">' + url + '</a>').append(copyText);
        },
